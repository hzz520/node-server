...
exports.uploadImgs = exports.removeImg = exports.uploadImg = exports.removeActivite = exports.editActivite = exports.addActivite = exports.getActiviteList = exports.removeColumn = exports.editColumn = exports.addColumn = exports.getColumnList = exports.removeGoods = exports.editGoodsStatus = exports.editGood = exports.addGood = exports.getGoodData = exports.getGoodsList = exports.projectEdit = exports.projectList = exports.permissionList = exports.authenticate = exports.login = exports.verify = void 0;
...
exports.login = function (req, res, next) {
    ...
    if (username == 'admin') {
        ...
        user_1.default.findOne({ username: username, password: new Buffer(md5(password)).toString('base64') }, '-meta -__v -_id -_id')
            .exec(function (err, response) {
            if (!err) {
                if (response) {
                    res.cookie('username', response.username, { maxAge: 24 * 3600 * 1000, path: '/' });
...
exports.getGoodData = function (req, res, next) {
    ...
    good_1.default.findOne({ good_id: mongoose.Types.ObjectId(good_id) }, '-meta -_id -__v')
        .populate([{
            path: 'good_activite_ids',
            options: {
                select: 'activite_name'
...
exports.editColumn = function (req, res, next) {
    ...
    column_1.default.findOne({ column_id: mongoose.Types.ObjectId(column_id) })
        .exec(function (err, response) {
        if (!err && response) {
...
exports.removeColumn = function (req, res, next) {
    ...
    column_1.default.findOneAndRemove({ column_id: mongoose.Types.ObjectId(column_id) }, function (err, response) {
        if (!err) {
...
exports.editActivite = function (req, res, next) {
    ...
    activity_1.default.findOne({ activite_id: mongoose.Types.ObjectId(activite_id) })
        .exec(function (err, response) {
        if (!err) {
...
exports.removeActivite = function (req, res, next) {
    ...
    activity_1.default.findOneAndRemove({ activite_id: mongoose.Types.ObjectId(activite_id) }, function (err, response) {
        if (!err) {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (good_id)
                                ...
                                projects_1.default.findOne({ project_id: mongoose.Types.ObjectId(project_id) })
                                    .exec(function (err, response) {
                                    if (response) {
                                        response.project_cover = imgSrc;
                                        response.save(function (err) {
...
exports.uploadImgs = function (req, res, next) {
    res.json({
        code: 1
    });
};
