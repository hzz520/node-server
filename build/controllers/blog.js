    ...
    if (req.body._id) {
        ...
        articleList_1.default.findOne({
            ...
            if (response == null)
                ...
                articleList_1.default.update({ _id: _id_1 }, { $inc: { pv: 1 } }, function (err, response1) {
                    articleList_1.default.findOne({
                        _id: id_1
                    })
                        .populate({
...
exports.updateUserInfo = function (req, res, next) {
    var _a = req.body, name = _a.name, userId = _a.userId, avatar = _a.avatar, oldPassword = _a.oldPassword, newPassword = _a.newPassword, type = _a.type;
